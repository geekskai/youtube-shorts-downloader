          ...
          <div className="mt-4 flex flex-col gap-3 border-t border-white/10 pt-4 sm:mt-5 sm:pt-5 lg:flex-row lg:items-end lg:gap-4">
            <div className="min-w-0 flex-1">
              ...
              <select
                ...
                className="min-h-11 w-full touch-manipulation rounded-xl border border-white/15 bg-slate-950/80 px-3.5 py-2.5 text-base text-slate-100 focus:border-emerald-400/60 focus:outline-none focus:ring-4 focus:ring-emerald-500/20 sm:text-sm"
              >
            ...
            <button
              ...
              className={`${btnClass} w-full shrink-0 bg-gradient-to-r from-emerald-600 to-violet-600 px-6 py-3.5 text-base text-white shadow-lg shadow-emerald-900/25 hover:brightness-110 lg:min-h-11 lg:w-auto lg:min-w-[11.5rem]`}
            >
              {downloading ? (
