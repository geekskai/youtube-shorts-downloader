...
const PAGE_PATH = "/youtube-audio-downloader"
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: "/static/images/og/youtube-audio-downloader.png",
          width: 1200,
          height: 630,
          alt: title,
        },
    ...
    twitter: {
      ...
      images: ["/static/images/og/youtube-audio-downloader.png"],
    },
    robots: { index: true, follow: true },
    alternates: { canonical },
    other: {
      "last-modified": AUDIO_LAST_MODIFIED,
    },
  }
}
